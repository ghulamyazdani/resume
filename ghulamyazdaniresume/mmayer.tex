...
\geometry{left=2cm,right=10cm,marginparwidth=6.8cm,marginparsep=1.2cm,top=1.0cm,bottom=1.0cm}
...
\begin{document}
\name{GHULAM YAZDANI}
\tagline{3rd year undergrad student @ Jamia Hamdard University, New Delhi}
% Cropped to square from https://en.wikipedia.org/wiki/Marissa_Mayer#/media/File:Marissa_Mayer_May_2014_(cropped).jpg, CC-BY 2.0
%\photo{3.3cm}{profile.jpg}
\personalinfo{%
  % Not all of these are required!
  % You can add your own with \printinfo{symbol}{detail}
 \href{mailto:ghulamyazdani12@gmail.com}{\email{ghulamyazdani12@gmail.com}} 
 \phone{+919953833675} 
%   \phone{000-00-0000}
%  \mailaddress{Address, Street, 00000 County}
  \location{New Delhi, India}
%  \homepage{marissamayr.tumblr.com/}
\href{https://twitter.com/iamyazreza}{\twitter{Twitter}} 
 \href{https://www.linkedin.com/in/ghulamyazdani}{\linkedin{LinkedIn}} 
  \href{https://github.com/ghulamyazdani}{\github{GitHub}}  % I'm just making this up though.
...
\cvevent{SDE Intern      \href{https://sager.ai/}{\textbf{sager.ai}}}{}{March 2022 -- present}{Remote}

\begin{itemize}
\item Created a scalable \textbf{GraphQL API} with \textbf{aws appsync} and connected it with datasource on \textbf{aws aurora}.
%\item Written query's for mutating data in SQL database.
...
\end{itemize}
\cvsection{Projects}
\cvproject{\href{https://communityverse.vercel.app/}{Community-verse} }
\begin{itemize}
...
\cvproject{\href{http://gitpic.vercel.app}{Gitpic} }
\begin{itemize}
...
\end{itemize}
\smallskip
\cvproject{\href{http://bugtrons.co}{Bugtrons event website} }
\begin{itemize}
...
\end{itemize}
\smallskip
\cvproject{\href{https://tweerup.herokuapp.com/tweet?username=iamyazreza}{TweetUp} }
\begin{itemize}
...
\cvsection{Opensource Cont.}
\cvproject{\href{https://meshery.io}{Meshery} }
\begin{itemize}
\item Contributed to a cloud-native management-based project website called Meshery built on Go, \& Jekyll, used by 100+ Companies . \href{https://github.com/meshery/meshery.io/graphs/contributors}{\textbf{Commits}}
\end{itemize}
\cvproject{\href{https://smp-spec.io}{Service-Mesh-Performance} }
\begin{itemize}
\item Debugged some bugs and contributed in User Interface fixes for the SMP website built on Ruby, Jekyll.used by 10+ companies \href{https://github.com/service-mesh-performance/service-mesh-performance/graphs/contributors}{\textbf{Commits}}
\end{itemize}
